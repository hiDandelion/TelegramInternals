...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    // site title
    title: 'Telegram iOS Internals',
    // site subtitle
    subtitle: 'Deep dives into a 274-module iOS codebase',
    // site description
    description: 'A deep-dive blog series explaining the Telegram iOS codebase — from its 274-module architecture to every major component implementation.',
    ...
    favicon: '/favicon.svg', // or https://example.com/favicon.svg
  },
